...
## 8. 기스 및 흠집
🧠 개념
- 생활기스 및 개인적으로 주차 및 출차시에 벽에 긁힌 흠집 확인

🧪 빠데 → 컴파운드 → 도색 내역
```
2025.11.25(일) 조수석 앞부분, 라이트 밑에 기스 및 흠집, 출차 시 벽을 긁음
2025.11.24(월) 빠데 → 컴파운드 → 도색 예정
```

- 2025.11.25(일)
![투싼기스1](/assets/images/notes/15_car_to_do/20251123_투싼_기스.jpg){: width="10%" height="10%"}{: .center}
